...
void WriteClientResponse()
{
    ...
    _client.write("<title>KMP Electronics Ltd. DiNo Ethernet - Web RS485 Test</title></head>");

    // Body
    _client.write("<body><div style='text-align: center'>");
    _client.write("<br><hr />");
    _client.write("<h1 style='color: #0066FF;'>DiNo Ethernet - Web RS485 Test example</h1>");
