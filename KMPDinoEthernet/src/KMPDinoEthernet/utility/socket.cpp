...
uint16_t recvfrom(SOCKET s, uint8_t *buf, uint16_t len, uint8_t *addr, uint16_t *port)
{
  ...
  if ( len > 0 )
  {
    ...
    {
    case SnMR::UDP :
      W5200.read_data(s, (uint8_t *)ptr, head, 0x08);
      ptr += 8;
      ...
      *port = (*port << 8) + head[5];
      ...
      W5200.read_data(s, (uint8_t *)ptr, buf, data_len); // data copy.
      ptr += data_len;
    ...
    case SnMR::IPRAW :
      W5200.read_data(s, (uint8_t *)ptr, head, 0x06);
      ptr += 6;
    ...
    case SnMR::MACRAW:
      W5200.read_data(s,(uint8_t*)ptr,head,2);
      ptr+=2;
      data_len = head[0];
      data_len = (data_len<<8) + head[1] - 2;

      W5200.read_data(s,(uint8_t*) ptr,buf,data_len);
      ptr += data_len;
      W5200.writeSnRX_RD(s, ptr);
      break;
