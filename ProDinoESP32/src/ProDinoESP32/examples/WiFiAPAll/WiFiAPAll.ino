...
// Description:
//		Test all: WiFi Access Point, relays, inputs, RS485, GROVE connector.
...
const char SSID[] = "ProDino-ESP32";
const char SSID_PASSWORD[] = "kmp12345";
...
#ifdef DEBUG
	Serial.println("");
	Serial.println("The example All WiFi APis started.");
