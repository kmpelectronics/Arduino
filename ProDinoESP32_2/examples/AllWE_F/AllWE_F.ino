...
// define two tasks
void ledAndDHT(void* pvParameters);
void processClients(void* pvParameters);
...
void setup()
{
	...
	xTaskCreatePinnedToCore(
		ledAndDHT,
		"ledAndDHT",			// A name just for humans
	...
	// Core 0 is stored for WiFi operations

	xTaskCreatePinnedToCore(
		processClients,
		"processClients",		// A name just for humans
