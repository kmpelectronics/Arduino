...
//		ProDino ESP32 Ethernet LoRa RFM V1 
// Description:
...
// if this define is uncommented example supports Ethernet if it is commented WiFi
#define ETH_TEST
...
byte _mac[] = { 0x00, 0x08, 0xDC, 0xDA, 0xA4, 0x9B }; 
...
void setup()
{
	delay(5000);
	Serial.begin(115200);
	Serial.println("The example simple MQTT is starting...");
	...
	Serial.println("\n\rThe example MqttBase is started.");
