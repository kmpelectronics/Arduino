...
#ifdef DEBUG
	SerialUSB.println("The server is started.");
...
{
	String page =
		"<html><head><title>" + String(KMP_ELECTRONICS_LTD) + " " + String(PRODINO_MKRZERO) + " - Opto inputs</title></head>"
		+ "<body><div style='text-align: center'>"
		+ "<br><hr />"
		+ "<h1 style = 'color: #0066FF;'>" + String(PRODINO_MKRZERO) + " - Opto inputs example</h1>"
		+ "<hr /><br><br>"
